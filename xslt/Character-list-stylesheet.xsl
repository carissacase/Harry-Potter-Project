...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="chapter">
        ...
        <li><u><xsl:apply-templates select="@chapTitle"/></u><br/>
            ...
            <xsl:if test="count(.//@scene) &gt; 0"><b><xsl:text>Movie scene number: </xsl:text></b><a href="Harry-Potter-Project/html-css/HPscript.html#{@scene}"><xsl:apply-templates select=".//@scene"/></a><br/></xsl:if>
