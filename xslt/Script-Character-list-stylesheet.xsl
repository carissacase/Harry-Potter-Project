...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        <html><head><meta name="viewport" content="width=device-width, initial-scale=1.0" />
            ...
            <body>
                <p>This project was conducted in order to compare the Harry Potter: Goblet of Fire novel and movie to see how the plot differentiates between the two. To analyze the script, we used Regex and XML markup to find every single time a character was mentioned and tag that mention so we could then compile a list of which characters were mentioned in which chapter.</p>
